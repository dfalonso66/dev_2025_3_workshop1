class Magic:
    ...
    def fibonacci(self, n):
        ...
        """
        if n < 0:
            raise ValueError("La posición en la secuencia no puede ser negativa.")
        elif n == 0:
            return 0
        elif n == 1:
            return 1
    ...
    def secuencia_fibonacci(self, n):
        ...
        """
        if n < 0:
            raise ValueError("La cantidad de números no puede ser negativa.")
        elif n == 0:
            return []
        elif n == 1:
            return [0]
    ...
    def es_numero_armstrong(self, n):
        ...
        suma = sum(int(digito) ** potencia for digito in num_str)
        return suma == abs(n)
